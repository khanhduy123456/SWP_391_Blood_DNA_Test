...
const SidebarCustomer = ({ role }: SidebarProps) => {
  ...
  return (
    <aside className="w-64 h-screen bg-gradient-to-b from-blue-50 to-white shadow-xl flex flex-col justify-between border-r border-blue-100 pt-8">
      <div>
        {/* Header */}
        <div className="p-6 border-b border-blue-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-gray-800">Quản lý Tài khoản cá nhân</h1>
